...
import { CheckBox, Platform } from "react-native-web";
import AppStatePage from "./Appstate";
import CheckboxPage from "./Checked";
import ClipboardPage from "./Clipboard";
import ImagePage from "./Image";
import LinkingPage from "./Linking";
import ModalPage from "./Modal";
import PressablePage from "./Pressable";
    ...
    <View style={styles.app}>
      <View style={styles.header}>
        <Image
          ...
          style={styles.logo}
        />
        <Text style={styles.title}>React Native for Sunny</Text>
      </View>
      <Text style={bold}>
        I am bold

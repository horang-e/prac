...
export default function ImagePage() {
  return (
    <>
      ...
      <Divider />
      {/* onError, onLoad, onLoadEnd, onLoadStart 등으로 로딩중, 에러 여부 파악 혹은 모두 로드 된 후에 뭔가 나타나게 설정할 수 있음 가령 예를 들면 사진이 모두 로드 되고 난 후에 글이 나타나게 한다거나 컴포넌트나 페이지 이동 등을 할 수 있을것 같음 */}
      <Image
      ...
      <View style={styles.row}>
        ...
        {/* 내부로 글씨가 들어갈 수 있게 설정 가능 */}
      <ImageBackground source={source} style={styles.image}>
        <Text style={styles.innertext}>Child content</Text>
      </ImageBackground>
